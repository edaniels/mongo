...
help = shellHelper.help = function (x) {
    if (x == "mr") {
        ...
        print("Keystrokes shown as 'Meta-key' may be entered as either Alt-key combinations or as Esc followed by key.")
        print("\nShell keystrokes:")
        print("  Tab, Ctrl-I                   autocomplete");
        print("  Ctrl-C                        exit shell");
        print("  Ctrl-G                        abort");
        print("  Ctrl-H (i.e. Backspace)       backwards delete one character");
        print("  Ctrl-Z                        suspend (unix-based systems)");
        print("\nHistory keystrokes:")
        print("  Up-arrow, Ctrl-P              previous line in history");
        print("  Down-arrow, Ctrl-N            next line in history");
        ...
        print("  Left-arrow, Ctrl-B            backwards one character");
        print("  Right-arrow, Ctrl-F           forwards one character");
        print("  Ctrl-left-arrow,");
        print("      Meta-left-arrow, Meta-B   backwards one word");
        print("  Ctrl-right-arrow,");
        print("      Meta-right-arrow, Meta-F  forwards one word");
